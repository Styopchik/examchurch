        ...
        <div class="main-content">
            ...
            <section class="section">
                <div class="section-body">
                    {{ Form::model($form, ['route' => ['forms.design.update', $form->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'design-form']) }}
                    <div class="row">
...
@push('script')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.spin-minus', function() {
            ...
            $(document).on('click', '.spin-plus', function() {
                var $input = $(this).parent().find('input');
                var val = 0;
                if ($input.val()) {
                    val = $input.val();
