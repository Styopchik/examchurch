            ...
            @else
                <div class="card">
                    ...
                    <div class="card-body form-card-body">
                                            ...
                                            @foreach ($rows as $row_key => $row)
                                                ...
                                                @elseif($row->type == 'selfie')
                                                    ...
                                                    <div class="row {{ $col }}" >
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-lg-6">
                                                                <label class="mb-2">{{ __('Full Name:') }}</label>
                                                                <input type="text" required   class="form-control"
                                                                    name="first_name_{{ $row->name }}"
                                                                    placeholder="Enter First name">
                                                                    @php
                                                                        $first_name = 'first_name_'.$row->name;
                                                                    @endphp
                                                                    {{-- {{ orm::text($first_name , $attr , ['class' => 'form-control' ,'placeholder' => __('Enter First name') ]) }} --}}
                                                    {{-- </div>
                                                            <div class="col-lg-6">
                                                                <label class="mb-2">{{ __('Last Name:') }}</label>
                                                                <input type="text"  @if ($row->required) required  @endif  class="form-control"
                                                                    name="last_name_{{ $row->name }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input type="email"  @if ($row->required) required  @endif  class="form-control"
                                                                    name="email_{{ $row->name }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-lg-5">
                                                                ...
                                                                <input type="tel"  @if ($row->required) required  @endif  class="form-control"
                                                                    name="phone_{{ $row->name }}"
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <div class="row mt-1">
                                                                    <div class="col-lg-2 d-flex align-items-center">
                                                                        <input type="radio"
                                                                            name="gender_{{ $row->name }}"
                                                                            value="male"
                                                                            id="male_{{ $row->name }}">
                                                                        <label style="margin-left:5px;"
                                                                            for="male_{{ $row->name }}">Male</label>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <input type="radio"
                                                                            ...
                                                                            id="female_{{ $row->name }}">
                                                                        <label style="margin-left:5px;"
                                                                            for="female_{{ $row->name }}">Female</label>
                                                                    </div>
                                                                    <div
                                                                        ...
                                                                        <input type="radio"
                                                                            ...
                                                                            id="other_{{ $row->name }}">
                                                                        <label style="margin-left:5px;"
                                                                            for="other_{{ $row->name }}">Other</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        {!! Form::open(['route' => ['coingatefillprepare'], 'method' => 'post', 'id' => 'coingate_payment_frms']) !!}
                    ...
                    <div class="card-body ">
                        <div class="m-auto form-group col-6">
                            ...
                            <div class="mt-3 social-links-share">
                                ...
                                <a href="javascript:void(0);" class="social-links-share-main" title="Show QR Code"
