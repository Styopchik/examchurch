...
@section('content')
    <section class="blog-page-banner" data-bg-image="{{ Storage::url(Utility::keysettings('background_image', 1)) }}" width="100%"
        height="100%">
        <div class="container">
            ...
            <div class="row">
                                    ...
                                    <div class="article-card-inner d-flex align-items-center">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="date d-flex align-items-center">
                                                ...
                                                {{ Utility::dateTimeFormat($recentBlog->created_at) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="author-info d-flex align-items-center justify-content-between">
                                            <div class="author-name d-flex align-items-center">
                                                <div class="author-img">
                                                    <img src="{{ asset('vendor/landing-page2/image/test-client-image.png') }}"
                                                        alt="client-image">
                                                </div>
                                                <span>{{ __('By. Author') }}</span>
                                            </div>
                                            <div class="date d-flex align-items-center">
                                                ...
                                                <span>{{ Utility::dateTimeFormat($lastBlog->created_at) }}</span>
                                            </div>
                                        </div>
                                        <h3>
                                            <a
                ...
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="blog-right-side append-blog-data">
                                    ...
                                    <div class="article-card-content">
                                        <div class="author-info d-flex align-items-center justify-content-between">
                                            <div class="date d-flex align-items-center">
                                                ...
                                                <span>{{ Utility::dateTimeFormat($blog->created_at) }}</span>
                                            </div>
                                        </div>
                                        <h3>
                                            <a href="{{ route('view.blog', $blog->slug) }}">
                        ...
                        @endforeach
                        {{ $blogs->links('blog.custom.pagination') }}
                    </div>
                </div>
            </div>
        </div>
