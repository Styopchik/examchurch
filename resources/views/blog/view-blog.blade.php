...
@section('content')
    <section class="blog-page-banner" data-bg-image="{{ Storage::url(Utility::keysettings('background_image', 1)) }}" width="100%" height="100%">
        <div class="container">
                ...
                <div class="col-12">
                    <div class="about-user d-flex align-items-center">
                        <div class="abt-user-info d-flex align-items-center">
                            <div class="abt-image">
                                <img src="{{ Storage::exists(Storage::url($user->avatar)) ?  Storage::url($user->avatar) :   asset('vendor/avatar-image/avatar.png') }}" alt="client-image">
                            </div>
                            <h6>
                        ...
                        <div class="post-lbl">
                            <b>{{ __('Date:') }}</b>{{ Utility::dateTimeFormat($blog->created_at) }}
                        </div>
                    </div>
                    <div class="section-title">
                            ...
                            <div class="article-card-content">
                                <div class="author-info d-flex align-items-center justify-content-between">
                                    <div class="date d-flex align-items-center">
                                        ...
                                        <span>{{ Utility::dateTimeFormat($oneBlog->created_at) }}</span>
                                    </div>
                                </div>
                                <h3>
                                    <a href="{{ route('view.blog', $oneBlog->slug) }}">
