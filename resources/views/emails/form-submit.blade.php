...
{!! Form::image(asset('storage/app/' . $formValue->Form->logo),null, ['id'=>'app-dark-logo','class'=>'img img-responsive my-5 w-30 justify-content-center text-center']) !!}
</div>
@endif
<table class="table table-bordered" style="width: 100%">
@foreach ($formValueArray as $rows)
