        ...
        <div class="section-body">
            <div class="col-md-6 m-auto">
                <div class="card ">
                    ...
                    {!! Form::open(['route' => 'faqs.store', 'method' => 'Post', 'enctype' => 'multipart/form-data', 'data-validate','novalidate']) !!}
                    <div class="card-body">
                        <div class="form-group ">
                            {{ Form::label('question', __('Quetion'), ['class' => 'form-label']) }}
                            {!! Form::text('question', null, ['class' => 'form-control', ' required', 'placeholder' => __('Enter question')]) !!}
                        </div>
                        <div class="form-group">
