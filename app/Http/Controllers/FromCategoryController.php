...
class FromCategoryController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('create-form-category')) {
            return view('form-category.create');
        } else {
            return redirect()->back()->with('failed', __('Permission denied.'));
        }
    }
    ...
    public function edit(string $id)
    {
        if (\Auth::user()->can('edit-form-category')) {
            ...
            return view('form-category.edit', compact('formCategory'));
        } else {
            return redirect()->back()->with('failed', __('Permission denied.'));
        }
    }
    ...
    public function destroy(string $id)
    {
        if (\Auth::user()->can('delete-form-category')) {
            ...
            return redirect()->route('form-category.index')->with('success', __('Category delteded successfully.'));
        } else {
            return redirect()->back()->with('failed', __('Permission denied.'));
        }
    }
